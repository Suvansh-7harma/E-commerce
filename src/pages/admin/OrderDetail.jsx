                    ...
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <tr key={index} className="text-gray-300">
                          ...
                          <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-green-600 first:border-l-0 border-gray-100 stroke-slate-500 text-slate-500 first-letter:uppercase ">
                            {order.status}
                          </td>
                          ...
                          <td
                            ...
                            className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-gray -100 stroke-slate-500 text-slate-500 text-gray-500 cursor-pointer "
                          >
                            Delete
                          </td>
                        </tr>
