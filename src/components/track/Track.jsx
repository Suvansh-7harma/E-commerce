...
const Track = () => {
  const [activeTrack, setActiveTrack] = useState(0); // Track index for highlighting

  useEffect(() => {
    // Function to cycle through tracks
    const interval = setInterval(() => {
      setActiveTrack((prev) => (prev + 1) % 3); // Update active track index
      ...
      <div className="container mx-auto px-5 py-10 md:py-14">
        ...
        <div className="flex flex-wrap -m-4 text-center">
          ...
          <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
            <div
              className={`border-2 px-4 py-6 rounded-lg ${
                activeTrack === 0
                  ? "shadow-xl shadow-gray-500 border-gray-500"
                  : "shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] border-gray-200 bg-gray-100"
              }`}
            >
              <svg
